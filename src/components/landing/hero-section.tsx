            ...
            <div className="container mx-auto px-4 sm:px-6 md:px-12">
                ...
                <div className="block md:hidden space-y-6">
                    ...
                    <div className="text-center space-y-6">
                        <h1 className="text-2xl sm:text-3xl font-extrabold font-headline text-blue-600 leading-tight">
                            {t.slogan}
                        </h1>
                    ...
                    <div className="flex items-center justify-center">
                        <Image
                            ...
                            width={600}
                            height={400}
                            className="rounded-lg shadow-xl object-cover w-full max-w-sm sm:max-w-md"
                    ...
                    <div className="flex justify-center">
                        <Button size="lg" asChild className="bg-blue-600 hover:bg-blue-700 text-white px-4 sm:px-6 py-3 sm:py-4 text-sm sm:text-base font-semibold">
                ...
                <div className="hidden md:grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                    <div className="text-center md:text-right space-y-6">
                        <div>
                            <h1 className="text-5xl lg:text-6xl xl:text-7xl font-extrabold font-headline text-blue-600 leading-tight mb-4 sm:mb-6">
                                {t.slogan}
                            </h1>
                            <p className="text-xl text-gray-700 mb-6 sm:mb-8 max-w-2xl mx-auto md:mx-0 font-medium">
                                {t.services.s3}
                            </p>
                    ...
                    <div className="flex items-center justify-center">
                        <Image
                            ...
                            width={600}
                            height={400}
                            className="rounded-lg shadow-xl object-cover w-full max-w-lg lg:max-w-xl"
                            data-ai-hint="digital archive document management"
                            priority
                        />
                    </div>
